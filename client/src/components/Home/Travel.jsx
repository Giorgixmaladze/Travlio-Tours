        ...
        <section className="py-20 bg-white">
            <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center gap-14">
                ...
                <div className="relative w-full md:w-1/2 shrink-0">
                    ...
                    <div className="absolute -bottom-5 -left-5 bg-orange-500 text-white rounded-md px-6 py-4 shadow-lg text-center hidden md:block">
                        <p className="text-3xl font-bold leading-none">1K+</p>
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 mb-2 leading-snug">
                        We Make Your Travel <br /> Dreams Come True
                    </h2>
                    <div className="w-12 h-1 bg-orange-500 rounded mb-5" />
                    <p className="text-gray-500 text-sm leading-relaxed mb-6">
                        With over 15 years of experience crafting unforgettable journeys, we pair
                        world-class destinations with personalized service — so every trip feels
