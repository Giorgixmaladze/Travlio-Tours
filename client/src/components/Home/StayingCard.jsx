const StayingCard = ({ tour }) => {
    return (
        <div className={`bg-cover bg-center w-full h-60 rounded-lg overflow-hidden`} style={{ backgroundImage: `url(${tour.image.url})` }}>
            <div className="bg-black/40 w-full h-full pl-5 pb-5 relative">
