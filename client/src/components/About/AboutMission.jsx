        ...
        <section className="py-16 bg-white">
            <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="relative w-full md:w-1/2 shrink-0">
                    ...
                    />
                    {/* Orange accent badge */}
                    <div className="absolute -bottom-5 -right-5 bg-orange-500 text-white rounded-md px-6 py-4 shadow-lg text-center hidden md:block">
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 mb-4 leading-snug">
                        We Create Unforgettable <br /> Travel Experiences
                    </h2>
                    <p className="text-gray-500 text-sm leading-relaxed mb-6">
                        At Travlio, we believe travel is more than just seeing new places — it's
                        about connecting with cultures, making memories, and returning home with
                        stories worth telling. Our team of passionate explorers designs every tour
