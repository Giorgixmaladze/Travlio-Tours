...
const SocialBtn = ({ children }) => (
    <a href="#" className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center text-gray-400 hover:bg-orange-500 hover:border-orange-500 hover:text-white transition-all duration-200">
        {children}
    </a>
)
    ...
    return (
        <footer>
            ...
            <div className="bg-[#252C41] pt-14 pb-10">
                <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="flex flex-col gap-5 sm:col-span-2 lg:col-span-1">
                        <img src={logo} alt="Travlio" className="w-32 brightness-0 invert" />
                    ...
                    <div className="flex flex-col gap-5">
                        <h4 className="text-white font-semibold text-base relative pb-3 after:absolute after:bottom-0 after:left-0 after:w-8 after:h-0.5 after:bg-orange-500">Quick Links</h4>
                    ...
                    {/* Categories */}
                    <div className="flex flex-col gap-5">
                        <h4 className="text-white font-semibold text-base relative pb-3 after:absolute after:bottom-0 after:left-0 after:w-8 after:h-0.5 after:bg-orange-500">Categories</h4>
                        <ul className="flex flex-col gap-2">
                            {categories.map((item) => (
                                <li key={item}>
                                    <a href="#" className="text-gray-400 text-sm hover:text-orange-400 transition-colors duration-200 flex items-center gap-1">
                    ...
                    {/* Contact */}
                    <div className="flex flex-col gap-5">
                        <h4 className="text-white font-semibold text-base relative pb-3 after:absolute after:bottom-0 after:left-0 after:w-8 after:h-0.5 after:bg-orange-500">Contact Us</h4>
            ...
            <div className="bg-[#1c2235] py-4">
                <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-2 text-center">
                    <p className="text-gray-500 text-xs">
                        © 2025 <span className="text-orange-400 font-medium">Travlio</span>. All rights reserved.
                    </p>
                    <p className="text-gray-600 text-xs">Designed with ♥ for travelers worldwide</p>
                </div>
            </div>
        </footer>
    )
